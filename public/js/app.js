...
(function (global, factory) {
   ...
   * ------------------------------------------------------------------------
   */
  var DATA_KEY$3 = 'lte.push-menu';
  var EVENT_KEY$3 = ".".concat(DATA_KEY$3);
  var EVENT_OPEN = "open".concat(EVENT_KEY$3);
  var EVENT_COLLAPSE = "collapse".concat(EVENT_KEY$3);
   ...
   */
  // const NAME = 'Treeview'
  var DATA_KEY$2 = 'lte.treeview';
  var EVENT_KEY$2 = ".".concat(DATA_KEY$2);
  var EVENT_EXPANDED$2 = "expanded".concat(EVENT_KEY$2);
  var EVENT_COLLAPSED$2 = "collapsed".concat(EVENT_KEY$2);
   ...
   * ====================================================
   */
  var DATA_KEY$1 = 'lte.direct-chat';
  var EVENT_KEY$1 = ".".concat(DATA_KEY$1);
  var EVENT_EXPANDED$1 = "expanded".concat(EVENT_KEY$1);
  var EVENT_COLLAPSED$1 = "collapsed".concat(EVENT_KEY$1);
    ...
    _createClass(CardWidget, [{
        ...
        if (this._parent) {
          ...
          elm.forEach(function (el) {
            if (el instanceof HTMLElement) {
              slideUp(el, _this._config.animationSpeed);
            }
          });
          setTimeout(function () {
            if (_this._parent) {
      ...
      value: function expand() {
        ...
        if (this._parent) {
          ...
          elm.forEach(function (el) {
            if (el instanceof HTMLElement) {
              slideDown(el, _this2._config.animationSpeed);
            }
          });
          setTimeout(function () {
            if (_this2._parent) {
              _this2._parent.classList.remove(CLASS_NAME_COLLAPSED);
              _this2._parent.classList.remove(CLASS_NAME_EXPANDING);
            }
          }, this._config.animationSpeed);
        }
        (_b = this._element) === null || _b === void 0 ? void 0 : _b.dispatchEvent(event);
      ...
      value: function maximize() {
        ...
        if (this._parent) {
          ...
          setTimeout(function () {
            ...
            if (_this3._parent) {
              _this3._parent.classList.add(CLASS_NAME_MAXIMIZED);
              if (_this3._parent.classList.contains(CLASS_NAME_COLLAPSED)) {
                _this3._parent.classList.add(CLASS_NAME_WAS_COLLAPSED);
              }
            }
          }, 150);
        }
      ...
      value: function minimize() {
        ...
        if (this._parent) {
          ...
          setTimeout(function () {
            ...
            if (_this4._parent) {
              _this4._parent.classList.remove(CLASS_NAME_MAXIMIZED);
              if ((_a = _this4._parent) === null || _a === void 0 ? void 0 : _a.classList.contains(CLASS_NAME_WAS_COLLAPSED)) {
                _this4._parent.classList.remove(CLASS_NAME_WAS_COLLAPSED);
              }
            }
          }, 10);
        }
  ...
  onDOMContentLoaded(function () {
    ...
    if (sidebarWrapper && typeof ((_OverlayScrollbarsGlo = OverlayScrollbarsGlobal) === null || _OverlayScrollbarsGlo === void 0 ? void 0 : _OverlayScrollbarsGlo.OverlayScrollbars) !== "undefined") {
